...
= 2.15.13 =
* Primär-, Sekundär-, Akzent- und Flächenfarben werden in Zentrale, Gastro-App, Events, Speisekarte und Reservierungsformular konsistent übernommen.
* Fest codierte grüne Navigations-, Filter-, Kalender- und Fokusfarben wurden durch die gespeicherten Branding-Werte ersetzt.

= 2.15.12 =
* Verhindert, dass die helle Branding-Oberfläche den Darkmode-Hintergrund auf Desktop, Tablet oder Smartphone überschreibt.

= 2.15.11 =
* Vereinheitlicht Hintergrund, Karten, Eingabefelder, Rahmen und Texte im Darkmode mit der Palette des Service-Bereichs.

= 2.15.10 =
* Vereinheitlicht den hellen Hintergrund aller Gelsensystem-Bereiche mit dem neutralen Grau des Service-Bereichs.

= 2.15.9 =
* Der Einklapp-Button der Seitenleiste liegt wieder vollständig vor dem Inhaltsbereich und wird nicht abgeschnitten.

= 2.15.8 =
* Alle Desktop-Menüs verwenden denselben Kopf, Online-Status, Darkmode- und Benutzerbereich.
* Bei kleinen Bildschirmhöhen bleibt die Bereichsliste scrollbar, während Darkmode und Abmeldung sichtbar bleiben.
* Darkmode, Online-/Offline-Anzeige und Anmeldung werden bereichsübergreifend geprüft.

= 2.15.7 =
* Die Reservierungsseite verwendet dieselbe Seitenbreite, Typografie und Kartengestaltung wie Events und Speisekarte.
* Formularfelder und Abstände wurden für Desktop, Tablet und Smartphone responsiv vereinheitlicht.

= 2.15.6 =
* Das Startseiten-Popup führt immer direkt zum zugehörigen Eintrag auf der internen Event-Seite.
* Eventdetails in der Backend-Übersicht sind standardmäßig eingeklappt und lassen sich einzeln öffnen.

= 2.15.5 =
* `/events/` wird direkt vom Gelsensystem gerendert, damit alte Enfold-Layout-Builder-Daten keinen EventON-Shortcode mehr ausgeben können.

= 2.15.4 =
* Die öffentliche Event-Seite unter `/events/` wird als eigenständige WordPress-Seite angelegt und funktioniert ohne EventON.
* Alte EventON-Seiteninhalte werden vor der automatischen Umstellung gesichert.
* Eine direkte Fallback-Ausgabe hält `/events/` auch bei fehlerhaften Permalinks oder fremden Archivregeln erreichbar.
