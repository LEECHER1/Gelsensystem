...
defined( 'GELSENDIELE_VERSION' ) || define( 'GELSENDIELE_VERSION', '2.15.10' );
...
require_once GELSENDIELE_DIR . 'includes/class-gelsensystem-events.php';
...
final class Gelsendiele_Reservierungsdashboard {
    ...
    public function redirect_legacy_app_urls() {
        ...
        $allowed_query = array();
        foreach ( array( 'gd-section', 'gd-view', 'edit', 'edit_item', 'edit_cat', 'edit_event', 'reservation_id', 'table_id', 'guest_name', 'guest_count' ) as $key ) {
    ...
    public function enqueue_assets() {
        ...
        $central_section = in_array( $app_section, array( 'settings', 'users', 'menu', 'tables', 'events' ), true );
        if ( $central_section ) {
    ...
    public function render_dashboard() {
        ...
        $app_section = isset( $_GET['gd-section'] ) ? sanitize_key( wp_unslash( $_GET['gd-section'] ) ) : 'reservations';
        if ( ! in_array( $app_section, array( 'reservations', 'settings', 'users', 'menu', 'tables', 'events' ), true ) ) {
            $app_section = 'reservations';
        }
        $section_capabilities = array(
            'reservations' => 'manage_bookings',
        ...
        <div class="gd-dashboard-shell gd-has-central-nav gd-central-section-shell" data-app-section="<?php echo esc_attr( $section ); ?>" style="<?php echo esc_attr( $brand_style ); ?>">
            ...
            <div class="gd-central-content">
                ...
                if ( 'settings' === $section ) {
                    ...
                    Gelsensystem_Events::render_app( $this->dashboard_url() );
                } else {
    ...
    private function render_central_navigation( $active ) {
        ...
        <aside class="gelsensystem-sidebar" aria-label="Gelsensystem Bereiche">
            ...
            <div class="gelsensystem-sidebar-controls">
                <span class="gelsensystem-sidebar-connection" data-sidebar-connection title="Verbindungsstatus"><i></i><span>Online</span></span>
    ...
    private function central_navigation_items() {
        ...
        return array(
            ...
            array( 'events', 'Events', 'gdg_manage', add_query_arg( 'gd-section', 'events', $dashboard ), 'V' ),
