...
nav_expect( false !== strpos( $dashboard_css, 'overflow:visible;flex-direction:column' ), 'Einklapp-Button wird am Seitenleistenrand abgeschnitten' );
nav_expect( false !== strpos( $dashboard_css, '--gd-bg: #f3f5f7;' ) && false === strpos( $dashboard_css, 'radial-gradient(circle at 8% -10%' ), 'zentraler heller App-Hintergrund unterscheidet sich vom Service-Bereich' );
nav_expect( false !== strpos( $gastro_css, '--gd-bg: #f3f5f7;' ), 'Service-Hintergrund verwendet nicht den gemeinsamen hellgrauen Farbwert' );
nav_expect( false !== strpos( $dashboard_css, '--gd-panel: #191f26;' ) && false !== strpos( $dashboard_css, '--gd-panel-2: #222a33;' ) && false !== strpos( $dashboard_css, '--gd-text: #f4f6f8;' ) && false !== strpos( $dashboard_css, '--gd-muted: #aeb7c1;' ) && false !== strpos( $dashboard_css, '--gd-border: #2d3640;' ), 'zentrale Darkmode-Palette unterscheidet sich vom Service-Bereich' );
nav_expect( false !== strpos( $dashboard_css, '--gd-bg: var(--gelsendiele-dark-surface, #08110b) !important;' ), 'helle Inline-Brandingfläche überschreibt den Darkmode-Hintergrund' );
nav_expect( false !== strpos( $gastro_css, '--gd-panel: #191f26;' ) && false !== strpos( $gastro_css, '--gd-panel-2: #222a33;' ) && false !== strpos( $gastro_css, '--gd-text: #f4f6f8;' ) && false !== strpos( $gastro_css, '--gd-muted: #aeb7c1;' ) && false !== strpos( $gastro_css, '--gd-line: #2d3640;' ), 'Service-Darkmode-Palette ist unvollständig' );
